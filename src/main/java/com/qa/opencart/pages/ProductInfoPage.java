...
public class ProductInfoPage {
	...
	private By successMsg=By.xpath("//div[@id='product-product']/div[1]");
	private By viewCartBtn1=By.xpath("//div[@id='cart']/button");
	private By viewCartBtn2=By.xpath("//div[@id='cart']/ul/li//p/a[1]");
	...
	public String addToCart() {
		eleUtil.doClick(cartBtn, TimeUtil.DEFAULT_TIME);
		return eleUtil.doGetText(successMsg);
	}
	public CartPage goToViewCartPage(){
		eleUtil.doClick(viewCartBtn1, TimeUtil.DEFAULT_TIME);
		eleUtil.doClick(viewCartBtn2, TimeUtil.DEFAULT_TIME);
