...
This feature contains all scenarios related to loginpage

  @login @smoke @regression @customTag @basic
  ...
  Scenario: Login to application
    Given the user is on the login page
    When the user logs in with username "vennela@gmail.com" and password "vennela2981"
